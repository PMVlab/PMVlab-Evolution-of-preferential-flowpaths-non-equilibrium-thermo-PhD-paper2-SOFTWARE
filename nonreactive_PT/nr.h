...
void flow(double y,double up[],double k[],double phi[],int NFlow);
float fmin(float x[]);
...
void newt(float x[], int n, int *check,
	void (*vecfunc)(int, float [], float []));
double normtpow(double,double,double,double(*gammq)(double,double));
...
void odeint2d(double ystart[], double x1, double x2, double k1[], double k2[], double p1[], double p2[], double phi2[], int N, double norm, double eps, double h1,
	double hmin, int *nok, int *nbad,
	void (*flow)(double [], double [], double [], double [], double [], double [], double [], int, double),
	void (*rkqs2d)( double [], double [], double [], double [], double [], int, double, double [], double [], double *, double, double, double [],
	double *, double *, void (*)(double [], double [], double [], double [], double [], double [], double [], int, double)));
...
double powdev(long *idum, double beta, double tau);
...
void rkck2d(double k1[], double k2[], double p1[], double p2[], double phi2[], int N, double norm,double y[], double dydx[], double x, double h, double yout[],
	double yerr[], void (*flow)(double [], double [], double [], double [], double [], double [], double [], int, double));
...
void rkqs(float y[], float dydx[], int n, float *x,
	...
	void (*derivs)(float, float [], float []));
void rkqs2d(double k1[], double k2[], double p1[], double p2[], double phi2[], int N, double norm,double y[], double dydx[], double *x, double htry, double eps,
...
double tpowdev(long *idum, double beta, double tau1, double tau2, double N);
double rangen(long *idum, double cdf[], int len, double xcdf[] );
